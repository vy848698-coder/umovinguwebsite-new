...
const iconMap: Record<string, string> = {
  ...
  buyer: '/passport-seller-and-buyer-icon/buyer.png',
  seller: '/passport-seller-and-buyer-icon/seller.png',
  ...
  alterationsAndPlanning: '/passport-seller-and-buyer-icon/alterationsAndPlanning.png',
  guaranteesAndWarranties: '/passport-seller-and-buyer-icon/gurantessAndWarranties.png',
  insurance: '/passport-seller-and-buyer-icon/insurance.png',
  environmental: '/passport-seller-and-buyer-icon/environmental.png',
  rightsAndInformalArrangements: '/passport-seller-and-buyer-icon/rightsAndInformalArrangements.png',
  parking: '/passport-seller-and-buyer-icon/parkings.png',
  otherCharges: '/passport-seller-and-buyer-icon/otherCharges.png',
  occupiers: '/passport-seller-and-buyer-icon/occupiers.png',
  services: '/passport-seller-and-buyer-icon/services.png',
  transactionInformation: '/passport-seller-and-buyer-icon/transactionInformation.png',
  fixturesAndFittings: '/passport-seller-and-buyer-icon/fixturesAndFittings.png',
  leasehold: '/op-icons/passportview/leasehold.svg',
  titleDeedsAndPlan: '/passport-seller-and-buyer-icon/titleDeedsAndPlan.png',
  searches: '/passport-seller-and-buyer-icon/searches.png',
  ...
  matchToBuyers: '/passport-seller-and-buyer-icon/matchToBuyers.png',
  ...
  buyerPropertyType: '/passport-seller-and-buyer-icon/propertyType.png',
  buyerAreaSqft: '/passport-seller-and-buyer-icon/areaSqft.png',
  buyerEpcRating: '/passport-seller-and-buyer-icon/epcRating.png',
  buyerTenure: '/passport-seller-and-buyer-icon/tenure.png',
  buyerYearBuilt: '/passport-seller-and-buyer-icon/yearBuilt.png',
  buyerTitleNumber: '/passport-seller-and-buyer-icon/titleNumber.png',
  tapTheOwner: '/op-icons/property/tapTheOwner.svg',
  registerInterestDrawer: '/op-icons/explore/registerInterest.svg',
  opLogo: '/op-icons/opLogo.png',
}
