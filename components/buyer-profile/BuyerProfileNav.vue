...
.bpnav-help { display: flex; align-items: center; gap: 5px; font-size: 13px; font-weight: 700; color: #10263d; background: rgba(255, 255, 255, 0.9); border: 1px solid rgba(173, 201, 231, 0.5); border-radius: 10px; padding: 7px 13px; cursor: pointer; transition: all 0.18s; font-family: inherit; }
...
.bpnav-back:hover { color: #10263d; border-color: #b9d5ea; }
